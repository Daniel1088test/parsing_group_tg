...
WEB_SERVER_HOST = os.getenv("WEB_SERVER_HOST", "parsinggrouptg-production.up.railway.app")  # Use environment variable or default to 0.0.0.0
WEB_SERVER_PORT = int(os.getenv("PORT", 8080))  # Use PORT environment variable (Railway sets this)
SECRET_KEY = '/QoXhzTJkyhzSKccxR+XV0pf4T2zqLfXzPlSwegi6Cs='  # Секретный ключ для Flask. Сгенерируйте случайную строку!
