...
urlpatterns = [
    ...
    path('sessions/add/', views.session_create_view, name='session_create_view'),
    path('sessions/<int:session_id>/edit/', views.session_update_view, name='session_update_view'),
    path('sessions/<int:session_id>/delete/', views.session_delete_view, name='session_delete_view'),
